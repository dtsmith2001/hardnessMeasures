...
public class MikeJ48
  ...
  public Capabilities getCapabilities() {
    ...
    try {
      if (!m_reducedErrorPruning)
        result = new MikeC45PruneableClassifierTree(null, !m_unpruned, m_CF, m_subtreeRaising, !m_noCleanup).getCapabilities();
      else
  ...
  public void buildClassifier(Instances instances) 
    ...
    if (!m_reducedErrorPruning)
      m_root = new MikeC45PruneableClassifierTree(modSelection, !m_unpruned, m_CF,
  ...
  public static void main(String [] argv){
    runClassifier(new MikeJ48(), argv);
  }
   ...
   * @throws Exception if distribution can't be computed successfully
   */
  public final double [] disjunctSize(Instance instance) 
       throws Exception 
   {
	   //System.out.println(m_root.getClass().toString());
	   if (m_root.getClass() == Class.forName("library.MikeC45PruneableClassifierTree"))
	   {
	      return ((MikeC45PruneableClassifierTree) m_root).getDisjunct(instance);
	   }
